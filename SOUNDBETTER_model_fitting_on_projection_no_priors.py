# -*- coding: utf-8 -*-
"""
Created on Fri Feb 17 18:44:06 2023
...
for SubID in range(20) :
    ...
    plt.savefig('Parameters_Convergence_Subject'+realSubIDs[SubID]+'_noPrior')
    os.chdir(datapath)
    plt.close()
...
for SubID in range(20):
    ...
    os.chdir('C:/Users/thoma/OneDrive/Documents/Consciousness_is_Bifurcation/Model_Fit')
    model_to_save.to_csv('ModelFit_Subject'+realSubIDs[SubID]+'_noPrior')
    os.chdir(datapath)
...
for SubID in range(20) : 
    ...
    plt.legend()
    os.chdir('C:/Users/thoma/OneDrive/Documents/Consciousness_is_Bifurcation/Model_Fit')
    plt.savefig('Empirical_VS_Fit_Subject'+realSubIDs[SubID]+'_noPrior')
    os.chdir(datapath)
    plt.close()
