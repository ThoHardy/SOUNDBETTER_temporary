# -*- coding: utf-8 -*-
"""
Created on Wed Feb 22 11:07:50 2023

@author: thoma
"""


#%% Fit the 2D polynomial version of the Bifurcation model with the data, with no bounds or pre-selection on
# the parameters
...
model_version = '_concave' # can be '_concave' or the empty string
...
for SubID in range(20) :
    ...
    plt.savefig('Parameters_Convergence_Subject'+realSubIDs[SubID]+'_noPrior_2DPoly'+model_version)
    os.chdir(datapath)
    plt.close()
...
for SubID in range(20):
    ...
    os.chdir('C:/Users/thoma/OneDrive/Documents/Consciousness_is_Bifurcation/Model_Fit')
    model_to_save.to_csv('ModelFit_Subject'+realSubIDs[SubID]+'_noPrior_2DPoly'+model_version)
    os.chdir(datapath)
...
for SubID in range(20) : 
    ...
    plt.legend()
    os.chdir('C:/Users/thoma/OneDrive/Documents/Consciousness_is_Bifurcation/Model_Fit')
    plt.savefig('Empirical_VS_Fit_Subject'+realSubIDs[SubID]+'_noPrior_2DPoly'+model_version)
    os.chdir(datapath)
    plt.close()